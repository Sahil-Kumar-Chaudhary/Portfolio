...
const Nav = () => {
  ...
  return (
    <nav className="flex flex-col items-center xl:justify-center gap-y-4 fixed h-max bottom-0 mt-auto xl:right-[2%] z-50 xl:top-0 w-full xl:w-16 xl:max-w-md xl:h-screen">
      <div className="flex w-full xl:flex-col items-center justify-around sm:justify-center sm:gap-x-6 xl:justify-center gap-y-10 px-2 sm:px-4 md:px-40 xl:px-0 h-[64px] sm:h-[72px] xl:h-max py-4 sm:py-8 bg-white/10 backdrop-blur-md text-xl sm:text-2xl xl:text-xl xl:rounded-full" style={{ paddingBottom: 'max(1rem, env(safe-area-inset-bottom))' }}>
        {navData.map((link, i) => (
          <a
            className={`${
